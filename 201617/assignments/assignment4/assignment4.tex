...
\title{Assignment 4: Photometric Stereo \\
Vision and Image Processing}
\author{Søren Olsen, Esben Plenge and Fran\c{c}ois Lauze}
\date{January 9, 2016}
\maketitle
...
{\bf The deadline for this assignment is Monday 23/1, 2016 at 20:00}. 
...
stereo. For that you will use two datasets provided to you on Absalon in the \texttt{Assignment 4 Code and data} folder,
