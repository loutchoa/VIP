...
\begin{itemize}
\item A bit on Training, Annotation, Transfer learning
% \item What can a neuron compute ?
% \item FC-net: The Universal approximation Theorem
\item Number of parameters and overfitting
\item Regularization
\item Convolutions
\item Optimization: Gradient descent, SGD etc
\item The zoo of network architectures (a start)
\end{itemize}
\vspace{4mm}
...
%-------------------------------------------------------------------
\begin{frame} 
  \frametitle{Fitting and model selection}
...
differences or as the {\color{red}{cross-entropy}}.
(more about this later) \\[6mm]
...
\begin{itemize}
\item Linear Algebra if the energy landscape is quadratic.
\item Gradient descent if the energy landscape is convex.
\item Simulated annealing if energy landscape is not simple.
\end{itemize}
...
Optimization of CNNs are almost exclusively done using a variant of
Gradient descent.
\end{frame}
