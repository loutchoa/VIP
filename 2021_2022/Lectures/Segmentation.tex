...
\date[2021-2022 B2]{January 10. \& 12., 2022} % (optional, should be abbreviation of conference name)
...
\begin{frame}{Localisation, Object Detection and Segmentation}
	\begin{picture}(320, 250)
		\put(-10, 185){\includegraphics[height=0.2\textheight]{IMAGES/a_dog}}
		\put( 85, 185){\includegraphics[height=0.2\textheight]{IMAGES/cat-and-dog}}	
		\put(0,175){
	...
	\put(170,145){\includegraphics[height=0.25\textheight]{IMAGES/localization-vs-detection}}
	\put(-5, 75){\includegraphics[height=0.3\textheight]{IMAGES/instance_segmentation_example}}
		\put(-5,65){
	...
	\put(135,45){\includegraphics[height=0.25\textheight]{IMAGES/sematic_vs_instance_segmentation}}
	\put(0, 10){
...
\begin{frame}{Canny Example}
  \begin{center}
	\includegraphics[width=0.8\textwidth]{IMAGES/Canny_example_SEGVIP}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Images and Topographic maps}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.3\textwidth]{IMAGES/cameraman}
  \end{center}
\begin{center}
    \includegraphics[width=0.7\textwidth]{FIGURES/topo_edge_map_cam}
...
\begin{frame}{Example}
  \begin{center}
    \includegraphics[width=0.75\textwidth]{FIGURES/cameraman_watershed}
  \end{center}
\end{frame}
...
\begin{frame}[t]{Gaussian Scale Space Features}
  ...
  \begin{center}
    \includegraphics[width=0.3\textwidth]{FIGURES/cameraman_kmeans_40_6}
  \end{center}
...
\begin{frame}[t]{Variation}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.3\textwidth]{FIGURES/cameraman_kmeans_36_6}
  \end{center}
  \begin{itemize}
  ...
  \pause
  \begin{center}
    \visible<2->{\includegraphics[width=0.3\textwidth]{FIGURES/cameraman_kmeans_4_6}}
  \end{center}
...
\begin{frame}[t]{Choice of $k$}
  ...
  \item Histogram of Cameraman Image $\pm$ 7 ``bumps'':
    \begin{center}
      \only<1>{\includegraphics[width=0.7\textwidth]{FIGURES/histogram_cameraman_raw}}
      \only<2->{\includegraphics[width=0.7\textwidth]{FIGURES/histogram_cameraman_with_annotations}}
    \end{center}
...
\begin{frame}{Deep Learning Approaches}
	...
	\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{FIGURES/CNN-architecture-based-on-UNET-Ronneberger-et-al}\\
