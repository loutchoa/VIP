...
\date[2021-22 B2] % (optional, should be abbreviation of conference name)
...
\begin{frame}
  \frametitle{Plan for today and December 13th, 2021}
  \begin{itemize}
...
\begin{frame}[t]{Materials and Light}
  ...
  \pause
  \put(40, 55){\includegraphics[width=0.2\textwidth]{FIGURES/Bust_Beethoven}}
  \put(105, 90)
  {
  ...
  \put(10,44)
  {
  	\begin{minipage}[t]{1.0\textwidth}\small
...
%	\vfill
%\begin{center}
%	\includegraphics[width=0.8\textwidth]{FIGURES/opaque}
%\end{center}
%\vfill
%\end{frame}
...
\begin{frame}{Camera Model}
	Two classical choices: orthographic and pinhole.
	\vfill
	\begin{center}
		\includegraphics[width=0.8\textwidth]{FIGURES/somecameramodels}
	\end{center}
\end{frame}
...
\begin{frame}[t]{Camera Model, Lambertian SfS equations }
  ...
  \item \color{blue}{Orthographic Camera Model}.
    ...
    \item Formula from settings slide: Coordinates of normal vector in orthographic projection:
      $$
  ...
  \begin{center}
    ...
    \Large \color{red}{Math and Research Topics}
  \end{center}
\end{frame}
