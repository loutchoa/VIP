...
\title{Assignment 2: Feature Eextraction and matching\\
Vision and Image Processing}
\author{Søren Olsen, Fran\c{c}ois Lauze, and Hong Pan}
\date{\today}
\maketitle
...
{\bf The deadline for this assignment is Monday 14/12, 2015 at 20:00}. 
...
(LoG), or the Harris- (or Noble-) corner detector.  You are allowed to
...
obtained in assignment 1. The less you program yourself, the more 
you are expected to show and explain the performance of the applied routine 
as function of the parameter setting for the routine.
\medskip
...
I see where in the images, how do the images differ, etc. In your
report you also have to explain the choices you made in your solution
as well as non-trivial details of your solutions.
\medskip

Advanced solutions may include considerations of how to extend your
solution to a multi-scale detector.
...
similarity/dissimilarity you have 2 choices:
\begin{enumerate}
\item The normalised cross correlation between the two patches
\item The sum of squared intensity differences
\end{enumerate}
For the first/second choice a high/low value signals a good match.
You are encouraged to implement and compare both possibilities.
In any case you should report the matching success as
$N$ is varied, say from 5 over 7 or 9 to 13 or even larger.
\medskip
...
\begin{enumerate}
\item The ratio of similarity/dissimilarity between the best and the
          second best match is too close to 1.
